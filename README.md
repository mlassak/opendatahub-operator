...
- [Developer Guide](#developer-guide)
  ...
  - [Run integration tests (Jenkins pipeline)](#run-integration-tests)
...
For instructions on how to run integration test Jenkins pipeline, please refer to [the following document](docs/integration-testing.md)
